...
from vitalab.empresarial.utils import gerar_pdf_exames, gerar_senha_aleatoria
...
def gerenciar_clientes(request):
    ...
    return render(
        request,
        'empresarial/gerenciar_clientes.html',
...
def cliente(request, cliente_id):
    ...
    return render(
        request,
        'empresarial/cliente.html',
        {'cliente': cliente, 'exames': exames},
    )
...
def exame_cliente(request, exame_id):
    ...
    return render(request, 'empresarial/exame_cliente.html', {'exame': exame})
...
def alterar_dados_exame(request, exame_id):
    ...
    exame.save()
    messages.add_message(
        request, constants.SUCCESS, 'Alteração realizada com sucesso'
    )
    return redirect(f'/empresarial/exame_cliente/{exame_id}')
